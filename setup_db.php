<?php
// setup_db.php - สคริปต์สร้างตารางอัตโนมัติผ่าน PHP MySQLi
header("Content-Type: text/plain; charset=UTF-8");
require_once "db_config.php";

echo "=== กำลังเชื่อมต่อไปยัง Aiven Cloud MySQL... ===\n";
...
if ($conn->multi_query($sql)) {
    ...
    echo "✅ สำเร็จ! ตาราง 5NF และข้อมูลเริ่มต้นทั้งหมดถูกติดตั้งลง Aiven เรียบร้อยแล้ว\n";
} else {
